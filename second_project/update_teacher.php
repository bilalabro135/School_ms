								...
								<form method ="post" action="process.php">
									<div class="card-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="fname" placeholder="Full Name" name="fname" value="<?php echo $teacher['fname']; ?>">
										</div>
										<div class="form-group">
											<label for="email">Last Name</label>
											<input type="text" class="form-control" id="email" placeholder="Enter Email" name="lname" value="<?php echo $teacher['lname']; ?>">
										</div>
										<div class="form-group">
									...
									<div class="card-action">
										<button class="btn btn-success" type="submit" name="submit_btn" value="update_teacher">Update</button>
									</div>
								</form>
							</div>
						</div>
