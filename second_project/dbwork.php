 ...
 session_start();
  class Mydb{
    ...
    public function update_teacher($data){
      extract($data);
      $query = "UPDATE `teachers` SET `fname` = '$fname', `lname` = '$lname', `phone_no` = '$phone_no' WHERE `id` = '$id'";
      $res = $this->conn->query($query);  
      return $res;
     ...
     public function update_student($data){
      extract($data);
      $query = "UPDATE `students` SET `fname` = '$fname', `lname` = '$lname', `phone_no` = '$phone_no' WHERE `id` = '$id'";
      $res = $this->conn->query($query);  
      return $res;
    ...
    public function add_teacher($data){
      extract($data);
      $sql = "INSERT INTO `teachers` (`fname`, `lname`, `age` , `qualification`, `gender`, `phone_no`, `address`, `salary`) VALUES ('$fname', '$lname', '$age', '$qualification', '$gender_id', '$phone_no', '$address', '$salary')";
      $res = $this->conn->query($sql);
      return $res;
    }
     ...
     public function add_student($data){
      extract($data);
      $sql = "INSERT INTO `students` (`fname`, `lname`, `fees` , `date_of_birth`, `date_of_admission`, `qualification`, `age`, `gender` , `phone_no`, `address`) VALUES ('$fname', '$lname', '$fees', '$date_of_birth', '$date_of_admission', '$qualification', '$age', '$gender_id', '$phone_no' , '$address')";
        $res = $this->conn->query($sql);
        return $res;
      }
